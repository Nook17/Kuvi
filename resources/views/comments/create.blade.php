...
{{-- <div class="col-md-11"> --}}
 <form action="{{ url('/comments') }}" method="POST">
  ...
  <div class="input-group ml-md-3 mb-md-2">
   <input type="text" class="form-control {{ $errors->has('post_' . $post->id . '_comment_content') ? ' is-invalid' : '' }}" name="post_{{ $post->id }}_comment_content" id="comment_content" placeholder="Your comment ..." aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('post_' . $post->id . '_comment_content') }}">
